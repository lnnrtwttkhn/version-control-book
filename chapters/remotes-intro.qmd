...
This can be very useful, when for example, your projects collaborators are working on a different bug than you. Now you want to see what progress they have made and if this affects your own work. You use `git fetch` to see what changes were made and see that these would in fact interfere with your work. You postpone the merge and can now safely readjust your own work to match the changes they've made. Using `git pull` would have meant blindly trusting that the changes won't mess with your own progress.
