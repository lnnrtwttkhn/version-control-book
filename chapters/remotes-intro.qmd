...
image: ../images/githubchapter.png
abstract: |
...
{{< include ../usecases/_usecase_remotesintro_collaboration.qmd  >}}
:::

::: {.callout-tip collapse="true"}
{{< include ../usecases/_usecase_remotesintro_backup.qmd >}}
:::
...
!["In case of fire" by [Louis-Michel Couture](https://github.com/louim) (License: [MIT](https://github.com/louim/in-case-of-fire/blob/master/LICENSE); [Source on GitHub](https://github.com/louim/in-case-of-fire))](../images/git-in-case-of-fire){#fig-git-in-case-of-fire width="60%"}
...
![Screenshot of the personal access token settings](../images/github-pat.png){#fig-pat}
...
![Screenshot of creating a new repository on GitHub](../images/github-newrepository.png){#fig-newrepo}
...
![Cloning a repository from GitHub (License: [CC BY 4.0](https://github.com/github/docs/blob/main/LICENSE)](../images/github-https-url-clone-cli.png){#fig-github-https-url-clone-cli width="50%"}
