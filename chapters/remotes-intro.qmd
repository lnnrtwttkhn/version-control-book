...
Both GitHub and GitLab will be addressed more in depth in later chapters as well.
...
::: {.callout-tip title="Which platform to choose: GitHub vs GitLab" collapse="true"}
Whilst there are several platforms out there, that can host your repositories, in this version control book, we focus on GitHub and GitLab.
But which should you choose?  
There isn't a universal answer to this and you can also choose both, but here are some things that might be worth considering.  
In general, GitHub is the most popular platform and GitLab is especially popular at universities.
GitHub's advantages are it's user-friendly interface, the rich ecosystem and it's extensive integration to third-party tools.
...
GitLab's advantages are it's integrated CI/CD system, project management tools, being able to fine-tune access for collaborators and it's open source approach.
There are unlimited free private repositories, but the maximum number of collaborators is five.
Potential disadvantages of GitLab are, that it isn't as popular, the user-interface feels less intuitive and the open-source community is less active.

Some other alternatives are [Bitbucket](https://bitbucket.org), [SourceForge](https://sourceforge.net) or [Codeberg](https://codeberg.org/).
::: 
