...
Start commit messages with an **imperative verb** like "Add", "Fix", or "Improve", instead of past tense ("Added" or "Fixed").
This helps explain what the commit does, not what was done.
