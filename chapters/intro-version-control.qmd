...
This also previews the contents of this book.

### We want to track changes

We want to understand what has happened to a file.

We want to link communication about our work (for example, a discussion with your collaborators about a new analysis) with the actual implementation in our work (for example, the actual implementation of the discussed analysis in programming code).
This is possible by using [issues](chapters/issues.qmd), which are a standard feature of Git hosting services like GitHub.

### We want to experiment

We want to work on a parallel version and integrate these parallel versions with our existing work.
We want to be able to go back to a previous versions that worked.
Git offers a powerful feature called [branches](chapters/branches.qmd).

### We want to collaborate

You are always collaborating.
Your number one collaborator is yourself from six months ago and she does not answer emails.

### We want to build on each other's work
