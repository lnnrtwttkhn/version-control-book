...
[{{< fa question-circle >}} Take the quiz!]({{< var quiz.intro >}}){.btn .btn-outline-secondary role="button"}
[{{< fa desktop >}} UHH WS 23/24]({{< var uhh-ws23.intro >}}){.btn .btn-outline-secondary role="button"}
...
![This illustration is created by [Scriberia](https://www.scriberia.com/) with [The Turing Way](https://the-turing-way.netlify.app/) community. Used under a [CC BY 4.0 licence](https://creativecommons.org/licenses/by/4.0/). DOI: [10.5281/zenodo.3695300](https://doi.org/10.5281/zenodo.3695300) (Version 3, [direct download link](https://zenodo.org/record/3695300/files/ProjectHistory.jpg?download=1)).](../static/project-history-turing-way)

!["A story told in file names", originally published 5/28/2010. "Piled Higher and Deeper" by Jorge Cham ([phdcomics.com](https://phdcomics.com/)). All content copyright 1997-2023 Piled Higher and Deeper Publishing, LLC. ([direct link](https://phdcomics.com/comics/archive.php?comicid=1323)).](../static/phd-comic-story-told-in-file-names.png){#fig-phd-comic-story-told-in-file-names}
