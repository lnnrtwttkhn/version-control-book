...
::: {.callout-tip title="Issues: Scientific usecases" collapse="true"}
- **Tracking research tasks and experiments:** 
...
Each issue can represent a task, which can be assigned to specific team members, prioritized, and tagged for easier management. This approach enhances task organization, ensuring accountability and progress tracking throughout the research process.

- **Managing and addressing reviewer feedback**: 
