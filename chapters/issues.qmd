...
GitHub Issues aren't just for software development—they can also be incredibly useful in scientific research. 
...
Each comment can be linked to specific changes in the manuscript, making it easy to ensure that all feedback is addressed. For instance, you can link a commit or pull request to a specific reviewer’s Issue, providing a clear record of how and when their feedback was incorporated.

### Labeling for Busy Supervisors
Supervisors who oversee multiple students or projects can use labels to quickly categorize Issues based on their priority or type. 
For example, labels like urgent, needs-review, or data-analysis can help supervisors prioritize their time and ensure that critical tasks are addressed promptly.

### Facilitating Peer Review
In collaborative projects, especially in academic or scientific settings, 
Issues can be used to manage peer review.
Different reviewers can be assigned to specific Issues, and labels can be used to track the progress of each review.
For instance, you might have labels like in-review, approved, or revisions-needed to indicate the status of each task or piece of code.

#### xample: Linking Reviewer Comments to Changes in a Paper
Imagine you're revising a manuscript based on reviewer comments. 
You can create an Issue for each reviewer's comments and link specific comments to corresponding changes in the manuscript. This might look like:
