...
After you click **Submit new issue**, your issue will be assigned a number.
You can see this number next to the title.
This number is also included in the URL of the page of the issue.
