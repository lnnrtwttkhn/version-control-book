...
image: ../images/git_bash_inst_14.png
abstract: |
...
[![Screenshot of gitforwindows.org](../images/git_bash_website.png){#fig-git_bash_website width="500"}](https://gitforwindows.org)
...
![](../images/git_bash_inst_2.png){width="200"} ![](../images/git_bash_inst_3.png){width="200"}![](../images/git_bash_inst_4.png){width="200"} ![](../images/git_bash_inst_5.png){width="200"} ![](../images/git_bash_inst_6.png){width="200"} ![](../images/git_bash_inst_7.png){width="200"} ![](../images/git_bash_inst_8.png){width="200"} ![](../images/git_bash_inst_9.png){width="200"} ![](../images/git_bash_inst_10.png){width="200"} ![](../images/git_bash_inst_11.png){width="200"} ![](../images/git_bash_inst_12.png){width="200"} ![](../images/git_bash_inst_13.png){width="200"}
...
![](../images/git_bash_inst_14.png){width="300"} ![](../images/git_bash_inst_15.png){width="300"}

Now a Bash window opens up and you should be able to use the command line and Git!

[![Screenshot of "Git Bash"](../images/git_bash_window.png){#fig-git_bash_window width="500"}](https://gitforwindows.org)
