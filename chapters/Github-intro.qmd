...
In the [setup chapter](Installation_and_setup.qmd) it is explained how to set a Username and Email for Git to use on your Computer.
...
In the [installation chapter](installation.qmd) it is explained how to create an account on [Github.com.](https://www.Github.com).
...
3.  Write your name below, stage and commit the change.
