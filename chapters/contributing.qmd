...
For details, see teh chapter on ["Citations & Footnotes"](https://quarto.org/docs/authoring/footnotes-and-citations.html) in the Quarto documentation.
...
1. display the first five lines (`echo=c(1:5)`) of this file
1. add code line numbers (`#| code-line-numbers: true`)
1. add a filename to the code block (`filename="_quarto.yml"`).
...
<details>
<summary>Click here for the output.>
```{bash, filename=„_quarto.yml“, echo=c(1:5)}
#| file: _quarto.yml
#| code-line-numbers: true
```
