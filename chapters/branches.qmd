...
[{{< fa question-circle >}} Take the quiz!]({{< var quiz.branches >}}){.btn .btn-outline-secondary role="button"}
[{{< fa desktop >}} UHH WS 23/24]({{< var uhh-ws23.branches >}}){.btn .btn-outline-secondary role="button"} 
