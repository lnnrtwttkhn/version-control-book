...
::: {.callout-tip title="Find out more: Common `git branch` flags" collapse="true"}
...
- **Feature Branches:** Theses branches are used for developing new features.
