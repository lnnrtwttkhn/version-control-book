...
2. If you collaborate with others on the same Git repository (we will look at collaboration with Git in the [chapter on GitHub](github-intro.qmd)) and everyone would work on the main branch simultaneously, this could cause a lot of confusion and conflicting changes.
...
`-a` or `--all`: Lists both local and remote branches. (Remote branches will be introduced in the [GitHub Intro](github-intro.qmd) chapter )
...
This section references some more advanced Git commits.
...
Use the commit process to save your work on the current branch.
...
If you only work locally on your computer, without a remote repository (for example, an online version of your repository on [GitHub](github-intro.qmd)), you can avoid merge conflicts easier because you are less likely to edit the same part of the same file on different branches.
