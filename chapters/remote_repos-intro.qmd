---
categories: [intermediate, github, gitlab remote]
image: ../static/githubchapter.png
abstract: |
  This chapter will introduce you to remote repository platforms, in particular GitHub and GitLab.
---
...
3. Enter the required personal details or create an account using e.g. your google account.
...
If you do not already have a project prepared it makes sense to select **join a project** to first gain access to GitLab. (You can create a new project anyway)
...
1. Click on the **New Project** button, usually found in the dashboard. 
...
If you create a **blank project** you will have to fill in the following details.
 ...
 - **Project Name**: 
Enter a name for your project. Avoid spaces and use hyphens (-) or underscores (_) instead.

- **Project Slug**: This is the end of the URL of your project.
...
Private: Accessible only by you and your collaborators.
