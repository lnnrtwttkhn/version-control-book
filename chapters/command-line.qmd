...
![Datasaab D22 mainframe computer from the 1960s. On exhibition at ITceum, Linköping, Sweden (by Lars Aronsson, taken from [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Televideo925Terminal.jpg) and used under a [Creative Commons ShareAlike 1.0 license](https://creativecommons.org/licenses/sa/1.0/)).](../static/mainframe-computer.jpg){width="70%"}

![A TeleVideo 925 computer terminal. (by Wtshymanski, taken from [Wikimedia Commons](https://commons.wikimedia.org/wiki/User:LA2) and in the [Public Domain](https://en.wikipedia.org/wiki/Public_domain)).](../static/terminal-computer.jpg){width="70%"}
