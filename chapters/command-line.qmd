...
For Linux and macOS users, you can install it via your package manager (e.g., `brew install tree `, if [Homebrew](https://brew.sh) is installed) to achieve the same.
:::
