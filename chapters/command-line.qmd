...
As briefly described in the [section on terminiology](#terminology), the default "programming language" of the command line is a version of the **shell**.
...
::: {.callout-tip collapse="true" title="Is Bash case sensitive?"}
