...
Note that if a path of yours contains a space, e.g.: `/Users/Your User/Downloads/Directory with Space/` it needs to be enclosed in quotes, to be recognized by the command line.
