---
image: ../images/terminal-computer.jpg
...
::: {.callout-warning title="Learning Git through RStudio? Feel free to skip this chapter!" collapse="true"}
Git is primarily a command-line tool.
Learning basic command-line skills is generally recommended.
However, if you use Git only through RStudio, you can skip this chapter for now.
We will use the command line just once to set up Git for the first time.
For more information, see the chapter on [setup](setup.qmd).
:::
...
](../images/command-line-bash.png){#fig-cli}
...
![Logo of the Git Bash program on Windows (Source: [Git for Windows on GitHub](https://avatars.githubusercontent.com/u/4571183?s=200&v=4))](../images/git-for-windows-logo.png){#fig-git-for-windows width="20%"}
...
![Icon of the Terminal program on macOS (Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Terminalicon2.png), License: Public Domain)](../images/terminal-icon.png){#fig-terminal width="20%"}
...
![Terminal icon in the Dock on macOS](../images/mac-dock.png){#fig-terminal-dock width="60%"}
...
![Screenshot of JupyterHub, showing the start screen.](../images/cli_jupyter.png){#fig-jupyter}
...
![Screenshot of JupyterHub, showing the terminal.](../images/cli_jupyter_2.png){#fig-jupyter_2}
...
## `curl`
```{zsh filename="Code"}
curl -O https://lennartwittkuhn.com/version-control-book/images/logo.svg
```

## `wget`
```{zsh filename="Code"}
wget https://lennartwittkuhn.com/version-control-book/images/logo.svg
```
:::
...
!["Hackerman" meme found on [Reddit.com](https://www.reddit.com/r/meme/comments/fu9f3b/command_prompt/)](../images/cli_meme.jpg){#fig-meme}
