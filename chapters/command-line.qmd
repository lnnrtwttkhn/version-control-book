...
Git is mainly a command-line tool.
Learning basic command-line skills is therefore generally recommended.
However, if you are using Git only through RStudio, you can skip this chapter for now.
We will use the command line only once to set up Git for the first time.
