...
Once you installed Git, it is time to set it up. We will do this from the command line. 
...
So it makes sense to set your email address to the one you used/will use to create a GitHub account.
...
However, there has been a growing movement to transition to using "main" as the default branch name instead. One of the main motivations behind this change is to promote inclusivity and remove potentially offensive terminology from the default Git workflow. 
...
This should create a long output list, in which you should find your set configurations, e.g.:
