...
On several installations of Git, by default, the name "master" for the initial branch is used when creating a new repository.
...
You can either pick up on the basics of Vim (see below) or simply change the text editor.
