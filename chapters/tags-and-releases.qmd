...
Here’s how you can tag a specific (old) commit:

**1. Find the Commit Hash:**
First, you need to identify the commit you want to tag. You can do this by listing the commits using:
```{bash}
git log --oneline
````
This command will show a list of commits along with their short hashes. 
Find the commit you want to tag and copy its hash.
...
By following these steps, you can easily tag any commit in your repository, even if it’s an older one. 
