...
(If you do not use the `-m` flag, your editor of choice will open up.) The tagging message can be a detailed description of the tag, such as release notes or significant changes.
So, for example:
...
Creating a GitHub release involves several steps, including associating the release with a Git tag, providing release notes, and attaching relevant assets.
...
3.  Choose an existing Git tag or create a new one.
    ...
    This title will be displayed on the GitHub Releases page.
