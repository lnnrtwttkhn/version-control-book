...
If you create an account on the normal [Zenodo](https://zenodo.org) site, you will have to create a new one to use the [Zenodo Sandbox](https://sandbox.zenodo.org), since they do not transfer.
...
You can delete the GitHub release without deleting your tag and create a new release, which is going to show up.
...
When you click on it there should be a section called **Markdown** with Markdown syntax below.
E.g:
```
...
You can copy paste this syntax into your `README.md` on GitHub to create a clickable DOI badge
