...
Lets´s say you accidentally commited (and pushed) a file you dont´t actually want to share because it contains sensitive data.
After you installed the `git filter-repo` tool, you can use it to exlude a specific file ftom you commit history.
