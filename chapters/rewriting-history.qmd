...
Of course you will only have to rewrite your Git history, if you "committed wrong" in the first place.
...
Lets´s say you accidentally committed (and pushed) a file you dont´t actually want to share because it contains sensitive data.
After you installed the `git filter-repo` tool, you can use it to exclude a specific file ftom you commit history.
...
As stated in this example, force pushing can be very useful if you e.g. committed and pushed data you want to take down again.
