...
The git config command in Git is used to get and set configuration.
It allows you to customize Git according to your preferences and requirements.
The configuration variables can be set at different levels: system, global, and local.
To look at the different Configuration commands you can use 
...
This level applies configuration values to every user on the system and all their repositories. 
To read or write configuration values at this level, you need administrative or superuser privileges.


**User-level Configuration**: 
This level is specific to an individual user. 
...
Th Configuration values set at this level override values set at the system-level and user-level configurations for that specific repository. 
...
Setting a Git editor allows you to work with a familiar and comfortable environment.
