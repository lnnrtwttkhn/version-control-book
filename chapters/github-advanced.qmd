...
abstract: |
  In this chapter, we will explore advanced GitHub features, including forking, pull requests and GitHub Flow
---
...
You can also submit changes to the original repository through so-called [pull requests](#pull-requests).

By clicking the **Fork** button on a repository page, shown in @fig-forking, you create an identical copy of the repository in your GitHub account.
...
You can see an example pull request within a repositiory down below.

![Screenshot of a Pull Request on GitHub](../static/pr_screenshot.png){#fig-pr}
A detailed description of the changes is provided by the PR author, along with sections for reviewers, assignees, labels, and milestones on the right-hand side.
...
7. **Delete branch:**
Once your branch has been successfully merged, it's clean-up time.
...
Template repositories, or repository templates, on GitHub allow you to create a repository that acts as a starting point for others. 
