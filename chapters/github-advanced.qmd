...
In addition, to these basic compontents, the pull request interface provides sections for reviewers, assignees, labels, and milestones on the right-hand side (see @fig-pr).
