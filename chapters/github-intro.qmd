...
Your Git username doesn't have to be the same as your GitHub username, but it's a good idea to keep them alike. This helps when checking who did what in the repository history or pull requests on GitHub.

As for your email, it also doesn't have to match the one you used for GitHub, but it's practical to use the same email to be able to track contributions on GitHub.

To set things up:
Use this command to set your Git username:

```{bash}
git config --global user.name "YourGitHubUsername"
```

Use this command to set your Git email:

```{bash}
git config --global user.email "you@example.com"
```

Replace "you@example.com" with the email you used for GitHub.
Doing this makes it clearer who contributed what and helps link your Git commits to your GitHub profile."
