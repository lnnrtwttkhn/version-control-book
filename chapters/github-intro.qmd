...
In this Chapter we will introduce working with GitHub, this includes:
...
### Authentication
Various authentication methods offer different advantages and drawbacks. 
...
Give your token a name, choose the desired scopes (permissions), and set an expiration date if needed.
...
![](../static/GitHub-newrepository.png)
...
By clicking the **Fork** button on a repository page, you create an identical copy in your GitHub account.

![](../static/GitHub-forking.png)
...
Using a GitHub repository template is as simple as clicking the "Use this template" button on a  template repository page, providing a new repository name and description, and then creating the repository with your desired settings.

![](../static/GitHub-template.png)
...
[GitLab](https://about.gitlab.com/de-de/), [Bitbucket](https://bitbucket.org), and [SourceForge](https://sourceforge.net).
...
#| warning: false
#| output: asis
bibtexkeys = c("bryan2023", "capes2023", "chacon2014")
knitr::kable(ref_table(bibtexkeys), format = "markdown")
```
