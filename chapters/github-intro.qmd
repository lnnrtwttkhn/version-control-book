...
about:
  ...
  links:
    - icon: question-octagon
      text: Take a quiz about this chapter!
      href: https://version-control-github.org
    - icon: display
      text: "UHH Course Session 2023/24"
      href: https://lennartwittkuhn.com/version-control-course-uhh-ws23/sessions/session09.html
---
# GitHub
