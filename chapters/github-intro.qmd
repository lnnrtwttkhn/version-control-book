...
If you want to upload an existing repository, you should not create a `README.md`, since your GitHub repository needs to be completely empty.
...
Before you make changes to your newly cloned repository you should use the `cd` to navigate into it.
This step of changing into the repository directory is crucial. 
Forgetting to do so may lead to confusion, as any Git commands you run will not affect the intended repository but rather the one associated with the current working directory.
