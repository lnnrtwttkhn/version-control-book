...
If you want to work in your newly cloned repository using the command line, you will need to move into the repository using the `cd`command.
...
Collaborators can directly contribute to your repository, without going through the forking process outlined above.
To add collaborators to yout GitHub repository, follow these steps.

1. On your repository page, click on the **Settings** tab located towards the right.

2. In the left sidebar, find and select **Collaborators** under the **Access** section.

3. In the "Collaborators" section, start typing the GitHub **username** or **email address** of the person you want to collaborate with.
GitHub will suggest usernames; select the appropriate user from the list.

4. Once you've selected the collaborator, click the **Add [username]** button.
This will send an invitation to the collaborator.

5. The collaborator will receive an **email notification** with the invitation. 
They can accept it by clicking the link provided in the **email** or directly on the GitHub repository page. 
