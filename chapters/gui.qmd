...
abstract: |
 ...
 Finally, we will dicuss specific use cases where a graphical user interface makes Git operations easier and less error-prone compared to the command-line.
---
...
1.    Install GitKraken or GitHub Desktop
1.    Login to the client using your GitHub Account and view your recipe repository
1.    Add two recipes in the same file, stage and commit only one of them, using a GUI
1.    Open your recipe repository in RStudio, edit a file and commit your changes
...
In general, GitHub Desktop's primary advantage lies in its integration with [github.com](github.com).
...
![Screenshot of Rstudio. Showing staging an example file.](../static/gitkraken-staging.png){#fig-GK_staging}
