...
![Screenshot of GitHub Desktop](../static/github-desktop-gettingstarted.png){#fig-GHD_start}
...
![Screenshot of GitHub Desktop](../static/github-desktop-window.png){#fig-GHD_window}
...
![Screenshot of GitKraken](../static/gitkraken-gettingstarted.png){#fig-GK_start}

After choosing a repository to track, you will see a visual representation of the commit history, branches, and commits.

![Screenshot of GitKraken](../static/gitkraken-window.png){#fig-GK_window}
...
![Screenshot of Rstudio](../static/gitkraken-staging.png){#fig-GK_staging}
...
![Screenshot of Rstudio](../static/gitkraken-mergeconflict.png){#fig-GK_commit}
...
![Screenshot of Rstudio](../static/rstudio-newproject.png){#fig-Rstudio_start}
...
![Screenshot of Rstudio](../static/rstudio-panels.png){#fig-Rstudio_window}
...
![Screenshot of Rstudio](../static/rstudio-commit.png){#fig-Rstudio_commit}
