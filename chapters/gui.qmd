---
image: ../images/gitkraken-gettingstarted.png
...
![Screenshot of GitHub Desktop. Showing the start screen.](../images/github-desktop-gettingstarted.png){#fig-GHD_start}
...
![Screenshot of GitHub Desktop. Showing an example repository.](../images/github-desktop-window.png){#fig-GHD_window}
...
![Screenshot of GitKraken. Showing the start screen.](../images/gitkraken-gettingstarted.png){#fig-GK_start}

After choosing a repository to track, you will see a visual representation of the commit history, branches, and commits.

![Screenshot of GitKraken. Showing an example repository.](../images/gitkraken-window.png){#fig-GK_window}
...
![Screenshot of GitKraken. Showing staging an example file.](../images/gitkraken-staging.png){#fig-GK_staging}
...
![Screenshot of Gitkraken. Showing an example merge conflict.](../images/gitkraken-mergeconflict.png){#fig-GK_commit}
...
![Screenshot of Rstudio. Showing the options for loading a repository.](../images/rstudio-newproject.png){#fig-Rstudio_start}
...
![Screenshot of RStudio. Showing an example repository.](../images/rstudio-panels.png){#fig-Rstudio_window}
...
![Screenshot of Rstudio. Showing an example commit.](../images/rstudio-commit.png){#fig-Rstudio_commit}
