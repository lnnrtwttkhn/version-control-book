...
## Hamburg/Rotterdam Guide :de: :netherlands:

### Command Line

::: {.callout-note title="Exercises" collapse="true" appearance="simple"}
{{< include ../exercises/_exercises-cli_ws24.qmd >}}
:::

::: {.callout-tip title="Solutions" collapse="true" appearance="simple"}
{{< include ../exercises/_solutions-cli_ws24.qmd >}}
:::

### Setup

::: {.callout-note title="Exercises" collapse="true" appearance="simple"}
{{< include ../exercises/_exercises-setup_ws24.qmd >}}
:::

::: {.callout-tip title="Solutions" collapse="true" appearance="simple"}
{{< include ../exercises/_solutions-setup_ws24.qmd >}}
:::

### First steps with Git

::: {.callout-note title="Exercises" collapse="true" appearance="simple"}
{{< include ../exercises/_exercises-first-steps-git_ws24.qmd >}}
:::

::: {.callout-tip title="Solutions" collapse="true" appearance="simple"}
{{< include ../exercises/_solutions-first-steps-git_ws24.qmd >}}
:::

### Git Essentials

::: {.callout-note title="Exercises" collapse="true" appearance="simple"}
{{< include ../exercises/_exercises-git-essentials_ws24.qmd >}}
:::

::: {.callout-tip title="Solutions" collapse="true" appearance="simple"}
{{< include ../exercises/_solutions-git-essentials_ws24.qmd >}}
:::

### Branches

::: {.callout-note title="Exercises" collapse="true" appearance="simple"}
{{< include ../exercises/_exercises-branches_ws24.qmd >}}
:::

::: {.callout-tip title="Solutions" collapse="true" appearance="simple"}
{{< include ../exercises/_solutions-branches_ws24.qmd >}}
:::

### GitHub: Intro

::: {.callout-note title="Exercises" collapse="true" appearance="simple"}
{{< include ../exercises/_exercises-github-intro_ws24.qmd >}}
:::

::: {.callout-tip title="Solutions" collapse="true" appearance="simple"}
{{< include ../exercises/_solutions-github-intro_ws24.qmd >}}
:::

### GitHub: Advanced

::: {.callout-note title="Exercises" collapse="true" appearance="simple"}
{{< include ../exercises/_exercises-github-advanced_ws24.qmd >}}
:::

::: {.callout-tip title="Solutions" collapse="true" appearance="simple"}
{{< include ../exercises/_solutions-github-advanced_ws24.qmd >}}
:::
