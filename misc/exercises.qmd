...
```{zsh, filename="Code"}
#| eval: false
#| file: code/code-exercises-first-steps.sh
#| code-line-numbers: true
#| code-overflow: scroll
```
{{< include ../exercises/_solutions-firststeps.qmd >}}
:::
[Download the repository](../zips/firststeps.zip){.btn .btn-outline-primary role="button"}
