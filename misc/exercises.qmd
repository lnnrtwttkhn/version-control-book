...
:::
[Download the repository](../zips/version-control-book-first-steps-git.zip){.btn .btn-outline-primary role="button"}
...
:::
[Download the repository](../zips/version-control-book-branches.zip){.btn .btn-outline-primary role="button"}
