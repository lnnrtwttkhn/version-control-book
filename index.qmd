...
This is *not* a guide to version control for software developers and computer scientists, who may have more advanced needs.
It is meant to be a gentle introduction to version control for (aspiring) scientists, who are seeking to become more effective in managing the evolution of digital objects on their computers.
...
We aim to simplify and demystify this complex tool for you.
...
This book takes a "command line first" approach.
Git is fundamentally a command-line tool which means you typically interact with it by typing text-based commands into a small command-line window rather than clicking on buttons in a graphical user interface (GUI).
...
We also believe in learning by doing and focus on implementation. 
Every concept introduced in this book is accompanied by practical examples, hands-on exercises and quizzes.
...
This book was initially created for the full-semester course "[Effective Progress Tracking and Collaboration: An Introduction to Version Control of Code and Data](https://lennartwittkuhn.com/version-control-course-uhh-ws23/)" at [Universität Hamburg](https://www.uni-hamburg.de), Germany.
...
If you find a typo, an unclear explanation, have an idea for a new chapter or want to see a specific topic covered you are more than welcome to open an issue or submit a pull request in the [GitHub repository]({{< var links.github >}}) of this book.

## Testimonials

Testimonials of students enrolled in the course ["An Introduction to Version Control of Code and Data"](https://lennartwittkuhn.com/version-control-course-uhh-ws23/) at Universität Hamburg, where this book acted as the primary learning resource:
