...
Our beautiful Logo symbolizes our bond to the two things that made this book possible: The Universität Hamburg and, of course, Git!

[![](static/git-logo.png){width="100"}](https://git-scm.com)
![](static/plus-solid.svg){width="100"}
[![](static/uhh-logo.png){width="100"}](https://www.uni-hamburg.de)
![](static/equals-solid.svg){width="100"}
![](static/logo.svg){ width="200"}

Special thanks to [Sophie Ottman](https://sophieottmann.de), who helped to realize this Logo!
